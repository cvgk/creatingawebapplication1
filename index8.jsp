...
<script>
    ...
    nedenaciklama,etkilendigialanlar,kaynak,baslangictarihi,ilce,koy,mahalle;
   function method3()
   {
	    ...
	    baslangictarihi = document.getElementById("bt").value;
	    window.location.replace("index9.jsp?il="+il+"&afetturu="+afetturu+"&baslangictarihi="+bt+"&serino="+
	    		serino+"&glideno="+glideno+"&bittar="+bittar+"&sure="+sure+"&belde="+belde+"&neden="+neden+
	    		 ...
	    		 etkilendigialanlar+"&kaynak="+kaynak+"&baslangictarihi="+baslangictarihi);
	    
   }
   function ilcedegisimi() {
	   il = document.getElementById("il").value;
	    afetturu = document.getElementById("afetturu").value;
	    bt = document.getElementById("bt").value;
	    serino = document.getElementById("serino").value;
	    ...
	    window.location.replace("index13.jsp?il="+il+"&afetturu="+afetturu+"&baslangictarihi="+bt+"&serino="+
	    		serino+"&glideno="+glideno+"&bittar="+bittar+"&sure="+sure+"&belde="+belde+"&neden="+neden+
	    		 "&enlem="+enlem+"&boylam="+boylam+"&nedenaciklama="+nedenaciklama+"&etkilendigialanlar="+
	    		 etkilendigialanlar+"&kaynak="+kaynak+"&baslangictarihi="+baslangictarihi+"&ilce="+ilce);
   }
    
   function koydegisimi(){
	   il = document.getElementById("il").value;
	    afetturu = document.getElementById("afetturu").value;
	    bt = document.getElementById("bt").value;
	    serino = document.getElementById("serino").value;
	    ...
	    ilce = document.getElementById("ilce").value;
	    koy = document.getElementById("koy").value;
	    window.location.replace("index16.jsp?il="+il+"&afetturu="+afetturu+"&baslangictarihi="+bt+"&serino="+
	    		serino+"&glideno="+glideno+"&bittar="+bittar+"&sure="+sure+"&belde="+belde+"&neden="+neden+
	    		 "&enlem="+enlem+"&boylam="+boylam+"&nedenaciklama="+nedenaciklama+"&etkilendigialanlar="+
	    		 etkilendigialanlar+"&kaynak="+kaynak+"&baslangictarihi="+baslangictarihi+"&ilce="+ilce+
	    		 "&koy="+koy);
   }
   function mahalledegisimi()
   {
	   il = document.getElementById("il").value;
	    afetturu = document.getElementById("afetturu").value;
	    bt = document.getElementById("bt").value;
	    ...
	    window.location.replace("index17.jsp?il="+il+"&afetturu="+afetturu+"&baslangictarihi="+bt+"&serino="+
	    		serino+"&glideno="+glideno+"&bittar="+bittar+"&sure="+sure+"&belde="+belde+"&neden="+neden+
	    		 "&enlem="+enlem+"&boylam="+boylam+"&nedenaciklama="+nedenaciklama+"&etkilendigialanlar="+
	    		 etkilendigialanlar+"&kaynak="+kaynak+"&baslangictarihi="+baslangictarihi+"&ilce="+ilce+
	    		 "&koy="+koy+"&mahalle="+mahalle);
   }
</script>
</head>
<body>
...
<form action="ServletUygulama" method="post">
 <table id="firsttable">
     ...
     <tr>
        ...
        <td><select name="il" onchange="method3()" id="il">
          ...
          <%
            ...
            for(int i=0;i<iller.size();i++)
            {
            	...
            	out.println("<option >"+ilsecimi.toString()+"</option>");
            	}
            }
          %>
        </select></td>
        ...
        <td><select name="ilce" id="ilce" onchange="ilcedegisimi()">
          ...
          <%
            ...
            {
            	Ilce k = ilceler.get(i);
            	if(k.toString().equalsIgnoreCase(ilce))
            	{
            		continue;
            	}else{
     ...
     <tr>
        <td>Koy</td>
        <td><select id="koy" name="koy" onchange="koydegisimi()">
          <option><% out.println(koy); %></option>
          <%
            KoyDAOImpl kdi = new KoyDAOImpl();
            List<Koy> koyler = kdi.ilceyeGoreKoyleriBul(ilce);
            for(int i=0;i<koyler.size();i++)
            {
            	Koy k = koyler.get(i);
            	if(k.toString().equalsIgnoreCase(koy))
            	{
            		continue;
            	}else{
            		out.println("<option>"+k+"</option>");
        ...
        <td>Mahalle</td>
        <td><select id="mahalle" name="mahalle" onchange="mahalledegisimi()">
          <option><% out.println(mahalle); %></option>
          <%
            MahalleDAOImpl mdi = new MahalleDAOImpl();
            List<Mahalle> mahalleler = mdi.koyeGoreMahalleyiBul(koy);
            for(int i=0;i<mahalleler.size();i++)
            {
            	Mahalle mah = mahalleler.get(i);
            	if(mah.toString().equalsIgnoreCase(mahalle))
            	{
            		continue;
            	}else{
            		out.println("<option>"+mah+"</option>");
            	}
            }
          %>
        </select></td>
