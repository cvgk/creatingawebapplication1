...
<title>il secimi yapilan sayfa</title>
<style>
    body {
       background: #e6f5ff;
       margin:0px;
...
<script>
   ...
   function method2()
   {
    ...
    for(var j=0;j<array1.length;j++)
    {
     ...
     nedenaciklama,etkilendigialanlar,kaynak,ilce;
     function method4()
     {
 	    ...
 	    window.location.replace("index6.jsp?il="+il+"&afetturu="+afetturu+"&baslangictarihi="+bt+"&serino="+
     ...
     <tr>
        ...
        <td><select name="ilce" id="ilce" onchange="method4()">
          ...
          <%
            ...
            List<Ilce> ilegoreilceler = ilcedao.ilceleriBul(il);
            for(int i=0;i<ilegoreilceler.size();i++)
            {
            	Ilce ilce = ilegoreilceler.get(i);
            	out.println("<option >"+ilce+"</option>");
            }
          %>
        </select></td>
