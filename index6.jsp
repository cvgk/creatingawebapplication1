...
function method2()
{
    ...
    nedenaciklama,etkilendigialanlar,kaynak,ilce,koy;
    function method5()
    {
    	 il = document.getElementById("il").value;
  	    ...
  	    window.location.replace("index7.jsp?il="+il+"&afetturu="+afetturu+"&baslangictarihi="+bt+"&serino="+
...
<form action="ServletUygulama" method="post">
 <table id="firsttable">
     ...
     <tr>
        ...
        <td><input type="text" name="baslangictarihi" id="bt" value="<%out.println(baslangictarihi);%>"/>
        <div class="c"></div></td>
        <td>Bitis Tarihi</td>
        <td><input type="text" name="bitistarihi" id="bittar" value="<%out.println(bittar);%>"/>
        <div class="c"></div></td>
        <td>Sure(Gun)</td>
     ...
     <tr>
        <td>Afet Turu</td>
        <td><input type="text" id="afetturu" value="<%out.println(afetturu);%>"></td>
        <td>Il</td>
        <td><input type="text" id="il" value="<%out.println(il);%>"></td>
        <td>Ilce</td>
        
        <td><input type="text" id="ilce" value="<%out.println(ilce);%>"></td>
     ...
     <tr>
        ...
        <td><select id="koy" name="koy" onchange="method5()">
          ...
          <%
            ...
            List<Koy> ilceleregorekoyler = koydao.ilceyeGoreKoyleriBul(ilce);
            for(int i=0;i<ilceleregorekoyler.size();i++)
            {
            	Koy koy = ilceleregorekoyler.get(i);
            	out.println("<option >"+koy+"</option>");
            }
          %>
        </select></td>
        <td>Mahalle</td>
     ...
     <tr>
       ...
       <td></td>
       <td></td>  
        <td class="k1"><div class="resim"></div><a href="index.jsp">Il Ilce Bul</a></td>
     </tr>
 </table>
 <table id="secondtable">
     <tr>
        <td>Neden Aciklama</td>
        <td><input type="text" class="a1" name="nedenaciklama" id="nedenaciklama" value="<%out.println(nedenaciklama);%>
        "/>
        </td>
     </tr>
     <tr>
        <td>Etkilendigi Alanlar</td>
        <td><input type="text" class="a1" name="etkilendigialanlar" id="etkilendigialanlar" 
        value="<%out.println(etkilendigialanlar);%>"/>
        </td>
     </tr>
     <tr>
        <td>Kaynak</td>
