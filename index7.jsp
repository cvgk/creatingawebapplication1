...
<form action="ServletUygulama" method="post">
 <table id="firsttable">
     ...
     <tr>
        <td>Afet Turu</td>
        <td><input type="text" id="afetturu" value="<%out.println(afetturu);%>" name="afetturu"></td>
        <td>Il</td>
        <td><input type="text" id="il" value="<%out.println(il);%>" name="il"></td>
        <td>Ilce</td>
        
        <td><input type="text" id="ilce" value="<%out.println(ilce);%>" name="ilce"></td>
     ...
     <tr>
        <td>Koy</td>
        <td><input type="text" id="koy" value="<%out.println(koy);%>" name="koy"></td>
        <td>Mahalle</td>
        <td><select id="mahalle" name="mahalle">
          <option>Seciniz</option>
          <%
             MahalleDAOImpl dao = new MahalleDAOImpl();
             List<Mahalle> mahalleler = dao.koyeGoreMahalleyiBul(koy);
             for(int i=0;i<mahalleler.size();i++)
             {
            	 Mahalle mahalle = mahalleler.get(i);
            	 out.println("<option>"+mahalle+"</option>");
             }
          %>
        </select></td>
        <td>Belde</td>
